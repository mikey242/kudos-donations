...
<div class="wrap">
	...
	<nav class="nav-tab-wrapper">
		<a href="?page=kudos-tools&tab=log"
		   class="nav-tab <?php
           echo ('log' === $tab) ? 'nav-tab-active' : ''; ?>">Log</a>
        <?php
        if (KUDOS_DEBUG):
            ?>
			<a href="?page=kudos-tools&tab=actions"
			   class="nav-tab <?php
               echo ('actions' === $tab) ? 'nav-tab-active' : ''; ?>">Actions</a>
        <?php
        endif; ?>
	</nav>
        ...
        switch ($tab) :
            ...
            case 'actions':
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_mollie'); ?>
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_twig_cache'); ?>
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_object_cache'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_transactions'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_donors'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_clear_subscriptions'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
				...
				<form action="<?php
                echo esc_url($url); ?>" method='post'>
                    <?php
                    wp_nonce_field('kudos_recreate_database'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
                ...
                echo esc_url($url); ?>" method='post' style="display: inline">
                    <?php
                    wp_nonce_field('kudos_sync_mollie_transactions'); ?>
					<button class="button-secondary confirm" type='submit' name='kudos_action'
					        value='kudos_sync_mollie_transactions'>Sync transactions
					</button>
				</form>
                ...
                <?php
                do_action('kudos_debug_menu_actions_extra', $url); ?>
