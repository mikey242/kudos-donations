...
trait TableTrait
{
    ...
    public function search_box($text, $input_id)
    {
		...
		<p class="search-box">
            ...
            echo esc_attr($input_id); ?>" name="s"
			       value="<?php
                   _admin_search_query(); ?>"/>
			<label for="search-field-selector" class="screen-reader-text"><?php
                _e(
                    'Select search field',
                    'kudos-donations'
                ) ?>></label>
			<select name="search-field" style="vertical-align: baseline" id="search-field-selector">
				<option value="-1"><?php
                    _e('Search field', 'kudos-donations') ?></option>
                <?php
    ...
    public function get_search_data(): ?array
    {
        ...
        if (isset($_REQUEST['s']) && isset($_REQUEST['search-field']) && isset(
                $this->column_names()[$_REQUEST['search-field']]
            )) {
