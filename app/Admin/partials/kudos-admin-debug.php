...
<div class="wrap">
    ...
    <div class="tab-content">
        ...
        switch($tab):
            case 'actions':
                ?>
	            <p>Please use the following actions only if you are having issues. Remember to backup your data before performing any of these actions.</p>
            ...
            case 'log':
                ...
                <form style="display:inline-block;" action="<?php echo admin_url( 'admin.php?page=kudos-debug' ) ?>" method='post'>
            ...
            case 'subscriptions':
                ...
                if($donors) {
                    ...
                    foreach($donors as $donor) {
                        ...
                        <form action="<?php echo admin_url( 'admin.php?page=kudos-debug&tab=subscriptions' ) ?>" method='post'>
