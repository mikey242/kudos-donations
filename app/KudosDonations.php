...
class KudosDonations
{
    ...
    {
        try {
            /** @var \IseardMedia\Kudos\Controller\Rest\RestRoutes $rest_routes */
    ...
    {
        try {
            /** @var \IseardMedia\Kudos\Controller\Admin $plugin_admin */
            ...
            add_action('admin_init', [$plugin_admin, 'check_migrations_pending']);
    ...
    {
        try {
            /** @var \IseardMedia\Kudos\Service\PaymentService $payment_service */
    ...
    {
        try {
            /** @var \IseardMedia\Kudos\Controller\Front $plugin_public */
