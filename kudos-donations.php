 ...
 */
\define( 'KUDOS_VERSION', '4.2.11-beta3' );
\define( 'KUDOS_DB_VERSION', '4.2.11' );
...
if ( ! \defined( 'KUDOS_DEMO_MODE' ) ) {
	\define( 'KUDOS_DEMO_MODE', false );
}
...
function activate(): void {
	...
	try {
		ContainerFactory::create()->get( Plugin::class )->on_plugin_activation();
	} catch ( \Throwable $e ) {
