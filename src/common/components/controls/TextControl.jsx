...
const TextControl = ({ name, validation, label, help, addOn, type = 'text', placeholder }) => {
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                    ...
                    className={classNames(
                      errors[name]?.message ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500 ' : 'border-gray-300 focus:ring-primary focus:border-primary',
                      addOn && 'pl-7',
