				...
				>
					<Switch
						...
						className={clsx(
							...
							'disabled:cursor-not-allowed relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-primary'
						)}
						aria-invalid={!!error}
