...
// Alias PHPUnit\Framework\Assert for the scoped Mollie SDK fake classes.
class_alias( \PHPUnit\Framework\Assert::class, \IseardMedia\Kudos\ThirdParty\PHPUnit\Framework\Assert::class );
