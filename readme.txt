...
* Fix php warning for missing InstalledVersions file

= 4.2.5 =
* Implement demo mode for WordPress playground
* "Show return message" now defaults to on
* Minor payment provider optimisations

= 4.2.4 =
* Fix migration notice showing for fresh installs
* Add additional attributes for custom css
* Update dependencies
...
* Improve handling of migration edge cases
...
* Fix page numbers not resetting when changing filter
...
* Fixed rare issue where plugin would not activate due to a rest api error
