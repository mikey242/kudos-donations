...
class Campaign extends BaseRepositoryRestController {
	...
	/**
	 * Get a single campaign by its slug.
	 *
	...
	public function get_item_by_slug( WP_REST_Request $request ) {
		...
		$item = $this->repository->find_one_by( [ 'wp_post_slug' => $slug ] );
	...
	public function get_item( WP_REST_Request $request ) {
		...
		// Try to find the entity by id and if none found assume it is the wp_post_id from earlier versions.
