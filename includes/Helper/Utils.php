...
class Utils {
	...
	public static function get_company_logo_svg(): string {
		return apply_filters( 'kudos_company_logo_svg', self::get_logo_svg() );
	}

	/**
	 * Returns the company logo PNG.
	 */
	public static function get_company_logo_png(): string {
		return apply_filters( 'kudos_company_logo_png', self::get_logo_png() );
	}
}
