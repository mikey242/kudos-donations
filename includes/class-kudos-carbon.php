...
class Kudos_Carbon {
	...
	public static function init() {
		...
		Container::make( 'theme_options', __( 'Kudos Settings', 'kudos' ) )
		...
		Block::make(__('Kudos Button', 'kudos'))
			...
			->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
				...
				<div class="kudos_block_button kudos_button">
						<a><i class="fas fa-hand-holding-heart"></i><span class="kudos_block_button_block__label"><?php echo esc_html( $fields['button_label'] ); ?></span></a>
				</div><!-- /.block -->
